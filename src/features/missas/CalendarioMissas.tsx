...
const CalendarioMissas: React.FC = () => {
  ...
  const escalas = [
    ...
    { id: "83-2025-07-03-19h-PqRosas", data: "2025-07-03", horario: "19h", local: "Parque das Rosas", padre: "Padre Rafael" },
    { id: "83-2025-07-03-19h-Mororo", data: "2025-07-03", horario: "19h", local: "Mororó", padre: "Padre Ivan" },

    { id: "83-2025-07-04-18h30-AdoracaoSS", data: "2025-07-04", horario: "18h30", local: "Centro Pastoral - Adoração", padre: "Padre Eudásio" },

    { id: "83-2025-07-05-17h-SantaLuzia", data: "2025-07-05", horario: "17h", local: "Santa Luzia", padre: "Padre Ivan" },
    { id: "83-2025-07-05-17h-SantoAntonio", data: "2025-07-05", horario: "17h", local: "Santo Antônio", padre: "Padre Rafael" },
    { id: "83-2025-07-05-19h-Matriz", data: "2025-07-05", horario: "19h", local: "Matriz", padre: "Padre Ivan" },
    { id: "83-2025-07-05-19h-Coite", data: "2025-07-05", horario: "19h", local: "Coité", padre: "Padre Rafael" },
