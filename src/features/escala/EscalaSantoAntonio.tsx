...
const EscalaSantoAntonio: React.FC = () => {
  ...
  const escalas = useMemo(
    ...
    { id: "80-2025-06-07-19h-SA", data: "2025-06-07", horario: "19h", local: "Santo Antônio", padre: "Padre Rafael" },
    { id: "80-2025-06-11-19h-SA", data: "2025-06-11", horario: "19h", local: "Santo Antônio", padre: "Padre Nonato" },
    { id: "80-2025-06-13-09h-SA", data: "2025-06-13", horario: "09h", local: "Santo Antônio", padre: "Padre Rafael" },
    { id: "80-2025-06-13-19h-SA", data: "2025-06-13", horario: "19h", local: "Santo Antônio", padre: "Padre Eudásio" },
    ],
    []
  );
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Escala Santo Antônio", 14, 22);
...
export default EscalaSantoAntonio;